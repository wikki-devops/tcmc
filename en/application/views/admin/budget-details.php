            ...
            <table id="table" class="table table-hover table-bordered table-striped dt-responsive nowrap"
                ...
                <thead>
                    <tr>
                        ...
                        <th>ID</th>
                        <th>Year</th>
                        <th>Budget Document</th>
                        <th>Council Approved On</th>
                        <th>Updated On</th>
                        <th>Published On</th>
                ...
                <tbody>
                    <?php $no = 1; ?>
                    <?php foreach ($budget as $variable): ?>
                        <tr data-id="<?= $variable['id']; ?>">
                            <form class="updateForm">
                                ...
                                <td>
                                    <span class="text"><?= $variable['budget_document']; ?></span>
                                    <input type="text" name="budget_document" class="edit-input d-none form-control" 
                                        value="<?= $variable['budget_document']; ?>">
                                </td>
                                <td>
                                    <span class="text"><?= $variable['council_approved_on']; ?></span>
                                    <input type="text" name="council_approved_on" class="edit-input d-none form-control" 
                                        value="<?= $variable['council_approved_on']; ?>">
                                </td>
                                <td>
