        ...
        <div class="row">
            <div class="col-lg-12 text-center justify-content-center align-content-center text-lg-start mb-60px">
                <p class="fs-16 fw-400 text-black mb-5px">
                    The Commissioner is the executive authority and the head of administration of Tambaram City
                    Corporation. The Commissioner is assisted by the City Engineer, City Health Officer, Assistant
                    Commissioners of ward offices, Executive Engineer (Planning), Assistant Commissioner (Personnel),
                    Assistant Commissioner (Revenue) and Assistant Commissioner (Accounts).
                </p>
                <p class="fs-16 fw-400 text-black mb-5px">
                    The personnel department looks after general administration of the Corporation including
                    establishment matters such as appointments, transfers, pay and allowances, housing employee welfare
                    schemes etc., correspondence with Government and other departments, public relations, redressal of
                    public grievances, legal matters and lawsuits and all matters related to office administration. For
                    administrative convenience, the Corporation has been divided into Five zones, namely
                </p>
                <p class="fs-16 fw-400 text-black mb-5px">
