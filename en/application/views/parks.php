                    ...
                    <div class="tab-pane fade in active show" id="zone_1">
                        <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 justify-content-center">
                            <table class="mt-30px border-radius-20px overflow-hidden w-auto mx-auto">
                                <thead>
                                    <tr>
                                        <th style="padding: 10px; text-align: left;"><strong>S.No</strong></th>
                                        <th style="padding: 10px; text-align: left;"><strong>Park Location</strong></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $sno = 1;
                            ...
                            <table class="mt-30px border-radius-20px overflow-hidden w-auto mx-auto">
                                <thead>
                                    <tr>
                                        ...
                                        <th><strong>Park Location</strong></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $sno = 1;
