...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/tambaramcorporation/tcmc@main/assets/css/tambaram.css">
...
<body id="zoom-text">
    ...
    <div class="main-header h-170px background-no-repeat position-relative z-index-9" style="background-image:url('<?= cdn_url(); ?>assets/images/nav-bg.png');">
        <div class="container pt-10px pb-10px position-relative z-index-3  header-top d-flex justify-content-between align-items-center">
            <div class="">
                <a href="<?= base_url(); ?>">
                    <img src="<?= cdn_url(); ?>assets/images/logo/logo-english.png" alt="Tambaram Corporation" class="w-auto h-100px" />
                </a>
            </div>
            <div class="">
                <a href="<?= base_url(); ?>"><img src="<?= cdn_url(); ?>assets/images/logo/tamilnadu.png" alt="Tamil Nadu Government "
            ...
            <div class="">
                ...
                <img src="<?= cdn_url(); ?>assets/images/logo/deputy-chief-minister.png" alt="Deputy Chief Minister of Tamil Nadu"
                    class="cm-img me-20px w-100px" />
            ...
            <div class="col-auto menu-order center-nav">
                ...
                <div class="collapse navbar-collapse justify-content-center d-flex" id="navbarNav">
                    <ul class="navbar-nav alt-font">
                        <li class="nav-item"><a href="<?= base_url() ?>" class="nav-link no-wrap text-white fs-16"><i
                                    class="d-inline fa-solid fa-house"></i>&nbsp;Home</a>
                        </li>
                        <?php foreach ($menus as $menu): ?>
                            <?php if (!empty($menu['submenus'])): ?>
                                <li class="nav-item dropdown">
                                    <a href="javascript:void(0);" class="nav-link no-wrap text-white ps-10px fs-16">
                            ...
                            <?php else: ?>
                                <li class="nav-item">
                                    <a href="<?= $menu['slug']; ?>" class="nav-link no-wrap text-white fs-16"><?= $menu['menu']; ?></a>
                                </li>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </ul>
        ...
        <div class="container">
            <div class="row d-flex footer-content" style="height: 100%;">
                <div
                    ...
                    <img src="<?= cdn_url(); ?>assets/images/logo/logo-english.png" alt="" class="mb-20px footer-logo"
                        style="width: 340px" />
                ...
                <div class="col-md-4 col-lg-4  pt-20px">
                    <div class="footer-app-download">
                        ...
                        <a href="https://play.google.com/store/apps/details?id=com.cma_mobile.beta" target="_blank"><img src="<?= cdn_url(); ?>assets/images/andriod.png" alt="Google Play" /></a>
