                ...
                <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center mb-5 md-mb-7">
                    <div class="col icon-with-text-style-10 md-mb-30px skrollable skrollable-between" data-bottom-top="transform: translateY(20px)" data-top-bottom="transform: translateY(-20px)" style="transform: translateY(-0.133779px);">
                        <div class="feature-box bg-white h-100 align-items-center box-shadow-quadruple-large box-shadow-quadruple-large-hover p-20px xl-p-30px border-radius-8px">
                            ...
                            <div class="feature-box-content last-paragraph-no-margin">
                                <span class="d-inline-block fw-600 text-dark-gray mb-5px fs-22">Total Population:
                                    10,11,328</span>
                            </div>
                        </div>
                    </div>
                    <div class="col icon-with-text-style-10 md-mb-30px skrollable skrollable-between" data-bottom-top="transform: translateY(20px)" data-top-bottom="transform: translateY(-20px)" style="transform: translateY(-0.133779px);">
                        <div class="feature-box bg-white h-100 align-items-center box-shadow-quadruple-large box-shadow-quadruple-large-hover p-20px xl-p-30px border-radius-8px">
                            ...
                            <div class="feature-box-content last-paragraph-no-margin">
                                <span class="d-inline-block fw-600 text-dark-gray mb-5px fs-22">Total SC Population:
                                    1,51,482</span>
                            </div>
                        </div>
                    </div>
                    <div class="col icon-with-text-style-10 md-mb-30px skrollable skrollable-between" data-bottom-top="transform: translateY(20px)" data-top-bottom="transform: translateY(-20px)" style="transform: translateY(-0.133779px);">
                        <div class="feature-box bg-white h-100 align-items-center box-shadow-quadruple-large box-shadow-quadruple-large-hover p-20px xl-p-30px border-radius-8px">
                            ...
                            <div class="feature-box-content last-paragraph-no-margin">
                                <span class="d-inline-block fw-600 text-dark-gray mb-5px fs-22">Total ST Population: 5,643</span>
                            </div>
                        </div>
                    </div>
                </div>
