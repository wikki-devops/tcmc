                        ...
                        <table id="table" class="table table-hover table-bordered table-striped dt-responsive nowrap"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>ID</th>
                                    <th>Zone</th>
                                    <th>Conversion of LED Lights</th>
                                    <th>Leftout area LED Lights</th>
                                    <th>Existing LED Lights</th>
                            ...
                            <tbody>
                                <?php $no = 1; ?>
                                <?php foreach ($streetlight as $variable): ?>
                                    <tr data-id="<?= $variable['id']; ?>">
                                        <form class="updateForm">
                                            ...
                                            <td>
                                                <span class="text"><?= $variable['conversion_led']; ?></span>
                                                <input type="text" class="edit-input d-none form-control"
                                                    name="conversion_led" value="<?= $variable['conversion_led']; ?>">
                                            </td>
                                            <td>
                                                <span class="text"><?= $variable['leftout_led']; ?></span>
                                                <input type="text" class="edit-input d-none form-control" name="leftout_led"
                                                    value="<?= $variable['leftout_led']; ?>">
                                            </td>
                                            <td>
                                                <span class="text"><?= $variable['existing_led']; ?></span>
                                                <input type="text" class="edit-input d-none form-control"
                                                    name="existing_led" value="<?= $variable['existing_led']; ?>">
                                            </td>
                                            <td>
