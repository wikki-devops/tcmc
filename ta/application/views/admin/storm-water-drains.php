                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="table" class="table table-hover table-bordered table-striped dt-responsive nowrap"
                            ...
                            <tbody>
                                <?php $no = 1; ?>
                                <?php foreach ($swd as $variable): ?>
                                    <tr data-id="<?= $variable['id']; ?>">
                                        <form class="updateForm">
                                            <td><?php echo $no++; ?></td>
                                            <td><?= $variable['id']; ?></td>
                                            <td>
                                                <span class="text"><?= $variable['drains']; ?></span>
                                                <input type="text" name="drains" class="edit-input d-none form-control"
                                                    value="<?= $variable['drains']; ?>">
                                            </td>
                                            <td>
                                                <span class="text"><?= $variable['length']; ?></span>
