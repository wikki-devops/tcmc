                    ...
                    <?php foreach ($amrut as $variable): ?>
                        <tr data-id="<?= $variable['id']; ?>">
                            <form class="updateForm">
                                ...
                                <td>
                                    <span class="text"><?= $variable['reforms']; ?></span>
                                    <input type="text" name="reforms" class="edit-input d-none form-control" 
                                        value="<?= $variable['reforms']; ?>">
                                </td>
                                <td>
