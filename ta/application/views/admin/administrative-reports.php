            ...
            <table id="table" class="table table-hover table-bordered table-striped dt-responsive nowrap"
                ...
                <thead>
                    <tr>
                        ...
                        <th>ID</th>
                        <th>Year</th>
                        <th>Administrative Report document</th>
                        <th>Updated On</th>
                        <th>Published On</th>
                ...
                <tbody>
                    <?php $no = 1; ?>
                    <?php foreach ($administrative as $variable): ?>
                        <tr data-id="<?= $variable['id']; ?>">
                            <form class="updateForm">
                                ...
                                <td>
                                    <span class="text"><?= $variable['administrative_report_document']; ?></span>
                                    <input type="text" name="administrative_report_document" class="edit-input d-none form-control" 
                                        value="<?= $variable['administrative_report_document']; ?>">
                                </td>
                                <td>
