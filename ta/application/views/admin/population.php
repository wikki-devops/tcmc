                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="table" class="table table-hover table-bordered table-striped dt-responsive nowrap"
                            ...
                            <tbody>
                                <?php $no = 1; ?>
                                <?php foreach ($population as $variable): ?>
                                    <tr data-id="<?= $variable['id']; ?>">
                                        <form class="updateForm">
                                            ...
                                            <td>
                                                <span class="text"><?= $variable['total_population']; ?></span>
                                                <input type="text" class="edit-input d-none form-control"
                                                    name="total_population" value="<?= $variable['total_population']; ?>">
                                            </td>
                                            <td>
                                                <span class="text"><?= $variable['sc_population']; ?></span>
                                                <input type="text" class="edit-input d-none form-control"
                                                    name="sc_population" value="<?= $variable['sc_population']; ?>">
                                            </td>
                                            <td>
                                                <span class="text"><?= $variable['st_population']; ?></span>
                                                <input type="text" class="edit-input d-none form-control"
                                                    name="st_population" value="<?= $variable['st_population']; ?>">
                                            </td>
                                            <td>
                                                <span class="text"><?= $variable['ward_no']; ?></span>
                                                <input type="text" class="edit-input d-none form-control" name="ward_no"
