                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="table" class="table table-hover table-bordered table-striped dt-responsive nowrap"
                            ...
                            <tbody>
                                <?php $no = 1; ?>
                                <?php foreach ($knowledge as $variable): ?>
                                    <tr data-id="<?= $variable['id']; ?>">
                                        <form class="updateForm">
                                            ...
                                            <td>
                                                ...
                                                <input type="text" class="edit-input d-none form-control" name="name"
                                                    value="<?= $variable['name']; ?>">
                                            </td>
                                            <td>
                                                <span class="text"><?= $variable['utilities']; ?></span>
                                                <input type="text" class="edit-input d-none form-control" name="utilities"
                                                    value="<?= $variable['utilities']; ?>">
                                            </td>
                                            <td>
                                                <span class="text"><?= $variable['amenities']; ?></span>
                                                <input type="text" class="edit-input d-none form-control"
                                                    name="amenities" value="<?= $variable['amenities']; ?>">
                                            </td>
                                            <td>
                                                <span class="text"><?= $variable['location']; ?></span>
                                                <input type="text" class="edit-input d-none form-control"
                                                    name="location" value="<?= $variable['location']; ?>">
                                            </td>
                                            <td>
