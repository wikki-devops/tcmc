    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="table" class="table table-hover table-bordered table-striped dt-responsive nowrap"
                ...
                <tbody>
                    <?php $no = 1; ?>
                    <?php foreach ($hospital as $variable): ?>
                        <tr data-id="<?= $variable['id']; ?>">
                            <form class="updateForm">
                                <td><?php echo $no++; ?></td>
                                <td><?= $variable['id']; ?></td>
                                <td>
                                    <span class="text"><?= $variable['hospital']; ?></span>
                                    <input type="text" name="hospital" class="edit-input d-none form-control" 
                                        value="<?= $variable['hospital']; ?>">
                                </td>                            
                                <td>
