                            ...
                            <div class="col tab-style-01">
                                <ul
                                    ...
                                    <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab"
                                            href="#zone_1">மண்டலம் 1</a></li>
                                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#zone_2">மண்டலம்
                                            2</a></li>
                                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#zone_3">மண்டலம்
                                            3</a></li>
                                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#zone_4">மண்டலம்
                                            4</a></li>
                                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#zone_5">மண்டலம்
                                            5</a></li>
                                </ul>
                                <div class="tab-content">
                                                        ...
                                                        <div class="h-100 p-20px border-radius-20px box-shadow text-center"
                                                            ...
                                                            <div class="ps-20px pe-20px">
                                                                ...
                                                                <p class="fs-16 fw-400 text-black mb-5px">
                                                                    <?= $new['partyname']; ?></p>
                                                                <p class="fs-16 fw-400 text-black mb-5px">வார்டு :
                                                                    <?= $new['ward_no']; ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
