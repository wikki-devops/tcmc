                ...
                <div class="col icon-with-text-style-01">
                    <div
                        ...
                        <div class="feature-box-content">
                            <span class="d-inline-block alt-font text-black fw-500 fs-17 mb-5px">புதுப்பிக்கப்பட்ட தேதி :
                                <span class="text-base-color"><?= $report['updated_on']; ?></span></span>
                            <span class="d-inline-block alt-font text-black fw-500 fs-17 mb-5px">வெளியிடப்பட்ட தேதி : <span
                                    class="text-base-color"><?= $report['published_on']; ?></span></span>
                            <a href="<?= $report['administrative_report_document']; ?>" target="_blank"
                                class="btn btn-small btn-rounded with-rounded m-auto border">பதிவிறக்க<span
