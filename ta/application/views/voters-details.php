            ...
            <div class="col icon-with-text-style-10 md-mb-30px skrollable skrollable-between"
                ...
                <div
                    ...
                    <div class="feature-box-content last-paragraph-no-margin">
                        <span class="d-inline-block fw-600 text-dark-gray mb-5px fs-22">மொத்த வாக்காளர்கள்:
                            7,77,939</span>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($voters as $count): ?>
                            <tr>
                                ...
                                <td><i class="fa-solid fa-transgender text-base-color me-5px"></i><?= $count['others']; ?>
                                </td>
