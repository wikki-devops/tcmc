            ...
            <div class="col tab-style-01">
                <ul class="nav nav-tabs justify-content-center border-0 text-center fs-18 alt-font fw-600 mb-30px">
                    <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#stand">
                           பேருந்து நிறுத்துமிடங்கள்</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#shelters">பேருந்து நிலையம்</a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade in active show" id="stand">
                        <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center mt-20px"
                                        ...
                                        <div
                                            ...
                                            <div class="bg-white">
                                                <div
                                                    ...
                                                    <p
                                                        class="d-inline-block fs-20 fw-600 text-dark-gray text-dark-gray-hover mb-5px ls-minus-05px">
                                                        <?= $bus['name']; ?></p>
                                                </div>
                                            </div>
                                        </div>
