...
// column_group_stacked



// dumbbell_chart

var chartColumnDumbellColors = getChartColorsArray("column_dumbbell_chart");
if (chartColumnDumbellColors) {
    ...
    var chart = new ApexCharts(document.querySelector("#column_dumbbell_chart"), options);
    chart.render();
}
