...
$(function () {
    ...
    $("#touchspin-1").TouchSpin(),
        ...
        $("#touchspin-9").TouchSpin({
            verticalbuttons: !0,
            verticalup: '<i class="mdi mdi-chevron-up fs-15 top-0"></i>',
            verticaldown: '<i class="mdi mdi-chevron-down fs-15 top-0"></i>'
        }),
        $("#touchspin-10").TouchSpin({
            buttonup_txt: t ? '<i class="fa fa-angle-left"></i>' : '<i class="fa fa-angle-right"></i>',
            buttondown_txt: t ? '<i class="fa fa-angle-right"></i>' : '<i class="fa fa-angle-left"></i>'
        }),
