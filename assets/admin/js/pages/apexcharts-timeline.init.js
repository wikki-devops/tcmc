...
var chartTimelineDumbellColors = getChartColorsArray("dumbbell_timeline");
if (chartTimelineDumbellColors) {
    var options = {
        series: [
            {
                data: [
        ...
        colors: chartTimelineDumbellColors,
        plotOptions: {
            bar: {
                horizontal: true,
                isDumbbell: true,
                dumbbellColors: [chartTimelineDumbellColors]
            }
        },
        title: {
        ...
        fill: {
            type: 'gradient',
            gradient: {
                gradientToColors: [chartTimelineDumbellColors[1]],
                inverseColors: false,
                stops: [0, 100]
            }
        },
    ...
    var chart = new ApexCharts(document.querySelector("#dumbbell_timeline"), options);
    chart.render();
}